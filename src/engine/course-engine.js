...
export const normalizeQuestion=q=>({type:q.type||'choice',q:String(q.q||''),options:Array.isArray(q.options)?q.options:[],answer:String(q.answer||''),sourceText:q.questionTarget||q.sourceText||null,targetText:q.questionSource||q.targetText||null,audioLanguage:q.audioLanguage||null});
